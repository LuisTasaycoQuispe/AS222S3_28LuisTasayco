					...
					<div class="seccContendr">
							...
							<form action="" method="post"
								...
								<div class="input-group">
									<input type="search" style="height: 45px;" id="inputBuscar"
										...
										name="BusquedaSeleccionada" aria-label="Username"
										aria-describedby="input-group-right"> <span
						...
						<div style="display: flex; gap: 30px; width: 800px;">
							...
							<a href="CrudBajas.jsp"><button type="button"
									style="height: 45px;" class="btn btn-primary"
									data-bs-toggle="modal" data-bs-target="#exampleModal">BAJAS</button>
							</a>
					...
					<tr>
						...
						<td>
							<div style="display: flex; justify-content: center; gap: 30px;">
								<a
									href="Editar.jsp?fecha=<%=fecha%>&codigo=<%=codigo%>&cantidad=<%=cantidad%>&detalle_bienes=<%=detalle_bienes%>&valor_libro=<%=valor_libro%>&fecha_depreciacion=<%=fecha_depreciacion%>&persona=<%=persona%>&area=<%=area%>">
									<button type="button" class="btn btn-secondary">
								...
								<form action="Eliminar" method="post"
									id="formEliminacion<%=codigo%>">

									<input type="hidden" id="codigo" name="codigo"
										value="<%=codigo%>"> <input type="hidden" id="codigo"
										name="estado" value="<%=Estado%>">
									<button type="button"
										onclick="eliminar(document.getElementById('formEliminacion<%=codigo%>'))"
							 ...
							 function eliminar(formulario) {
						            Swal.fire({
						                ...
						                if (result.isConfirmed) {
						                	 ...
						                	 Swal.fire({
				            				      title: "Eliminado!!",
				            				      text: " ha sido eliminado logicamente",
				            				      icon: "success"
				            				    });
